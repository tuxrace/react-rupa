...
var hasCORS = __webpack_require__(347);
...
var debug = __webpack_require__(321)('socket.io-parser');
var json = __webpack_require__(374);
...
var XMLHttpRequest = __webpack_require__(115);
var XHR = __webpack_require__(327);
var JSONP = __webpack_require__(326);
var websocket = __webpack_require__(328);
...
var eio = __webpack_require__(323);
...
var Backoff = __webpack_require__(316);
...
var parser = __webpack_require__(153);
var Emitter = __webpack_require__(252);
var toArray = __webpack_require__(608);
var on = __webpack_require__(250);
var bind = __webpack_require__(174);
var debug = __webpack_require__(95)('socket.io-client:socket');
var hasBin = __webpack_require__(180);
...
var _reactTapEventPlugin = __webpack_require__(581);

var _reactTapEventPlugin2 = _interopRequireDefault(_reactTapEventPlugin);

var _AppBar = __webpack_require__(186);
...
var _FontIcon = __webpack_require__(83);
...
var _face = __webpack_require__(479);

var _face2 = _interopRequireDefault(_face);

var _checkCircle = __webpack_require__(219);
...
var _typing = __webpack_require__(264);
...
var _toky = __webpack_require__(265);

var _toky2 = _interopRequireDefault(_toky);
...
var socket = __webpack_require__(603)('https://rupamessage1.mybluemix.net/');
...
var Chat = function (_Component) {
  ...
  function Chat(props) {
    ...
    _this.state = {
      ...
      voice: _react2.default.createElement(
        _FontIcon2.default,
        { className: 'material-icons', style: { margin: 5, color: 'white' } },
        'mic'
      ),
      typing: false,
      interim: null,
  ...
  _createClass(Chat, [{
    ...
    value: function componentDidUpdate() {
      ...
      toky.onresult(function (result) {
        ...
        if (result.final) {
          ...
          _this2.setState({ cog: result.final_transcript });
          socket.emit('add', result.final_transcript);
          _this2.setState({ interim: null });
        } else {
          _this2.setState({ interim: result.interim_transcript });
        }
      });
      toky.onend(function () {
        console.log('end');
        _this2.setState({ voice: _react2.default.createElement(
            _FontIcon2.default,
            { className: 'material-icons', style: { margin: 5, color: 'white' } },
            'mic'
          ) });
    ...
    value: function handleMessage(chats) {
      ...
      var user = last.sender === 'user' && true;
      if (chats) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_AppBar2.default, { style: _style.style, title: 'RUPA', iconElementLeft: _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { style: { display: 'flex', justifyContent: 'space-around', width: '100vw', padding: '2em', background: '#fff' } },
          _react2.default.createElement(_text2.default, textProps),
          _react2.default.createElement(_RaisedButton2.default, { style: { height: 60, margin: 3 }, secondary: true, label: 'Submit Message', onClick: this.handleSend.bind(this), icon: _react2.default.createElement(_checkCircle2.default, null) }),
          _react2.default.createElement(_RaisedButton2.default, { style: { height: 60, margin: 3 }, secondary: true, label: 'Use Voice', icon: this.state.voice, onClick: this.handleStart.bind(this) })
        )
      );
    }
  }]);
...
var Bubble = function Bubble(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      { style: right ? styleRight : style },
      text
    ),
    _react2.default.createElement('div', { style: right ? triRight : tri })
  );
};
...
var _bubble = __webpack_require__(259);

var _bubble2 = _interopRequireDefault(_bubble);

var _dview = __webpack_require__(260);
...
var Message = function Message(_ref) {
  ...
  var list = chats.map(function (x, index) {
    console.log(x);
    var bot = x.sender === 'bot';
    var html = x.type === 'html';
    var view = html ? _react2.default.createElement(_dview2.default, { right: false, text: x.data }) : _react2.default.createElement(_bubble2.default, { right: !bot, text: x.data });
    var listProps = {
      key: Math.random().toString(),
      leftAvatar: bot ? _react2.default.createElement(_Avatar2.default, { src: 'images/rupa.png' }) : null,
  ...
  return chats.length > 0 ? _react2.default.createElement(
    'div',
    null,
    list
  ) : null;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement('path', { fill: 'tomato', className: 'path1', d: 'M16 6c-1.717 0-3.375 0.271-4.928 0.804-1.46 0.502-2.76 1.211-3.863 2.108-2.069 1.681-3.209 3.843-3.209 6.088 0 1.259 0.35 2.481 1.039 3.63 0.711 1.185 1.781 2.268 3.093 3.133 0.949 0.625 1.587 1.623 1.755 2.747 0.056 0.375 0.091 0.753 0.105 1.129 0.233-0.194 0.461-0.401 0.684-0.624 0.755-0.755 1.774-1.172 2.828-1.172 0.168 0 0.336 0.011 0.505 0.032 0.655 0.083 1.325 0.126 1.99 0.126 1.717 0 3.375-0.271 4.928-0.804 1.46-0.502 2.76-1.211 3.863-2.108 2.069-1.681 3.209-3.843 3.209-6.088s-1.14-4.407-3.209-6.088c-1.104-0.897-2.404-1.606-3.863-2.108-1.553-0.534-3.211-0.804-4.928-0.804zM16 2v0c8.837 0 16 5.82 16 13s-7.163 13-16 13c-0.849 0-1.682-0.054-2.495-0.158-3.437 3.437-7.539 4.053-11.505 4.144v-0.841c2.142-1.049 4-2.961 4-5.145 0-0.305-0.024-0.604-0.068-0.897-3.619-2.383-5.932-6.024-5.932-10.103 0-7.18 7.163-13 16-13z' })
      ),
...
var Typing = function Typing() {
    return _react2.default.createElement("img", { src: "images/typing.gif" });
};
...
var Toky = function () {
    ...
    _createClass(Toky, [{
        ...
        value: function onresult(callBack) {
            var final_transcript = void 0;
            var interim_transcript = void 0;
            var final = false;
...
Socket.Transport = __webpack_require__(114);
...
if (typeof window === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(612);
  } catch (e) { }
}
...
;(function () {
  ...
  var isLoader = "function" === "function" && __webpack_require__(610);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(154)(module), __webpack_require__(20)))
...
if (global && global.ArrayBuffer) {
  base64encoder = __webpack_require__(317);
}
...
var Blob = __webpack_require__(318);
...
var EventConstants = __webpack_require__(512);
...
var TouchEventUtils = __webpack_require__(579);
...
should be injected by the application.'
  ...
  __webpack_require__(62).injection.injectEventPluginsByName({
    'TapEventPlugin':       __webpack_require__(578)(shouldRejectClick)
  });
};
...
exports.Socket = __webpack_require__(251);
...
var _chat = __webpack_require__(255);
